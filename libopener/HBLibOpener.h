...
/*
 ...
 @return The shared instance of the HBLibOpener class.
 */
...
/*
 ...
 @return YES if the handler was registered successfully. Returns NO if an error occurred.
*/
...
/*
 ...
 @return YES if the handler is enabled, or uses a custom Preferences list controller. Returns NO if
